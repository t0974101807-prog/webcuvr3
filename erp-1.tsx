...
import { 
  ...
  Heart, MessageCircle, Bookmark, HardDrive, Github, Database, Slack, FileJson, CreditCard, Link
} from "lucide-react";
...
// 2. Cấu trúc dữ liệu thư mục nhóm vụ việc (Hình 2)
...
export default function ErpLegalMeetingWorkspace() {
  const [activeWorkspaceTab, setActiveWorkspaceTab] = useState<"ERP_DATABASE" | "MEETILY_AI" | "VIBEVOICE_SIMULATOR" | "SPECKIT_SDD" | "MCP_PLAYGROUND">("MCP_PLAYGROUND");
  const [activeSidebarCategory, setActiveSidebarCategory] = useState<string>("Tranh tụng");

  // --- STATE QUẢN LÝ HỒ SƠ KHÁCH HÀNG (Mục 1) ---
